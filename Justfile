...
app PROJECT="" CHART="" MODE="":
    ...
    for var in FTS_COLLAB_HOST FTS_COLLAB_JOIN FTS_COLLAB_NAME FTS_COLLAB_TICKET FTS_COLLAB_PUPPET FTS_COLLAB_PUPPET_TRANSPORT FTS_WINDOW_POS FTS_WINDOW_SIZE; do

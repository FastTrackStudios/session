...
app PROJECT="" CHART="" MODE="":
    ...
    for var in FTS_COLLAB_HOST FTS_COLLAB_JOIN FTS_COLLAB_NAME FTS_COLLAB_TICKET FTS_COLLAB_PUPPET FTS_COLLAB_PUPPET_TRANSPORT FTS_COLLAB_PUPPET_MOUSE FTS_WINDOW_POS FTS_WINDOW_SIZE FTS_SESSION_SONG FTS_AUDIO_MODE FTS_AUDIO_TARGET SESSION_DAW_REAPER FTS_SOCKET FTS_STREAM_SOURCE FTS_LOAD FTS_TASK_SERVER FTS_TASK_ORG FTS_TASK_TOKEN XDG_DATA_HOME; do

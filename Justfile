...
# drum template. Scenes are `plan::SCENES`: drum-recording, drum-mixing,
# drum-overview, lead-vocal, lead-vocal-fx, drum-fund, drum-fx. In the
# window the number keys 1–7 recall the same scenes, and 0 goes back to
# the rail's preset.
